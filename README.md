...
> و**مصدّر ساكن** لا يُنشئ ملفاً للعبة مرفوضة. كل ذلك مثبت ببوابات أُثبت عدم فراغها بحقن عيوب
...
$ npm test
  ...
  ✓ prove_runtime.py · 148 فحصاً: DDL + ترحيلان حقيقيان + اللوحات الثمانية + بوابة الترخيص
    + الحارس + التصدير الساكن + المثبّت
